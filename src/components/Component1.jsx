...
const Component1 = ({
  ...
  return (
    <div
      ...
      style={frameDivStyle}
    >
      <h1 className="m-0 w-[218px] h-8 relative text-inherit font-medium font-inherit inline-block shrink-0 max-w-[67%] mq1050:text-7xl mq450:text-lgi">
        {orchestrators}
      </h1>
      <div className="ml-[-121px] w-[571px] h-[629px] relative shrink-0 max-w-[175%] text-base">
        <div className="absolute top-[0px] left-[121px] tracking-[0.02em] leading-[19.2px] inline-block w-[336px] z-[1]">
          {orchestratorsWillBeRespon}
        </div>
        <div className="absolute top-[70px] left-[0px] w-[571px] h-[559px] flex flex-row items-start justify-start">
          <div className="h-full w-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px]">
            ...
            />
            <img
              className="absolute top-[31px] left-[341.3px] rounded-xl w-[122.2px] h-[53.7px] object-contain z-[1]"
              alt=""
              src={frame512918690}
            />
          </div>
