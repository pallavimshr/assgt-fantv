          ...
          <div className="self-stretch h-[559.9px] relative">
            <div className="absolute top-[0px] left-[0px] w-full h-full">
              <img
                ...
                src="/pattern.svg"
              />
              <div className="absolute top-[17px] left-[249px] rounded-81xl bg-mediumpurple w-[200px] h-14 z-[1]" />
            </div>
            <button className="cursor-pointer [border:none] py-4 pr-[58px] pl-[59px] bg-white absolute top-[12px] left-[249px] rounded-81xl flex flex-row items-start justify-start gap-[6px] z-[2]">
